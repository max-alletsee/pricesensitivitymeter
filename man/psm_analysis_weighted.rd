...
\description{
\code{psm_analysis_weighted()} works just as \code{psm_analysis()}.
  However, this documentation still requires some work and is
...
\arguments{
  ...
  \item{design}{data.frame or matrix that contains the function's
